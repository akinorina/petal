...
マイページ [frontend/src/app/(admin)/me/](../../frontend/src/app/(admin)/me/) に導線を集約。実装: [backend/src/auth/](../../backend/src/auth/), [backend/src/user/](../../backend/src/user/)
...
- マイページ `/me`（[frontend/src/app/(admin)/me/](../../frontend/src/app/(admin)/me/)）。
